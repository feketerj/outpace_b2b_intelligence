...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/admin" element={<ProtectedRoute requireSuperAdmin><SuperAdminDashboard /></ProtectedRoute>} />
      <Route path="/admin/tenants" element={<ProtectedRoute requireSuperAdmin><TenantsPage /></ProtectedRoute>} />
      <Route path="/admin/users" element={<ProtectedRoute requireSuperAdmin><UsersPage /></ProtectedRoute>} />
      <Route path="/admin/database" element={<ProtectedRoute requireSuperAdmin><DatabaseManager /></ProtectedRoute>} />
      <Route path="/preview" element={<ProtectedRoute requireSuperAdmin><TenantPreview /></ProtectedRoute>} />
