...
|----|-------|----------|------|--------|---------|
| `super_admin_001` | admin@outpace.ai | Admin123! | super_admin | null | Super admin operations |
| `tenant_admin_a` | admin-a@test.com | Test123! | tenant_admin | tenant-a | Tenant A admin |
| `tenant_admin_b` | admin-b@test.com | Test123! | tenant_admin | tenant-b | Tenant B admin |
| `tenant_user_a1` | user-a@test.com | Test123! | tenant_user | tenant-a | Regular user A |
| `tenant_user_b1` | user-b@test.com | Test123! | tenant_user | tenant-b | Regular user B |
| `tenant_user_a2` | user2-a@test.com | Test123! | tenant_user | tenant-a | Second user A (concurrency) |
| `inactive_user` | inactive@test.com | Test123! | tenant_user | tenant-a | `is_active=false` |
| `expired_user` | expired@test.com | Test123! | tenant_user | tenant-expired | Expired tenant user |
| `noquota_user` | noquota@test.com | Test123! | tenant_user | tenant-noquota | No quota user |
| `master_admin` | master@test.com | Test123! | tenant_admin | tenant-master | Master tenant admin |
| `norag_user` | norag@test.com | Test123! | tenant_user | tenant-norag | No RAG user |
| `readonly_user` | readonly@test.com | Test123! | tenant_user | tenant-a | Read-only tests |
...
|----|------|-------|----------|------|
| AUTH-H-001 | Super admin login | admin@outpace.ai / Admin123! | 200, access_token | L17-49 |
| AUTH-H-002 | Tenant admin login | admin-a@test.com / Test123! | 200, access_token | L17-49 |
| AUTH-H-003 | Tenant user login | user-a@test.com / Test123! | 200, access_token | L17-49 |
