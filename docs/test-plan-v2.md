...
|----|-------|----------|------|--------|---------|
| USR-001 | admin@outpace.ai | Admin123! | super_admin | None | Super admin operations |
| USR-002 | admin-a@test.com | Test123! | tenant_admin | tenant-a | Tenant A admin |
| USR-003 | admin-b@test.com | Test123! | tenant_admin | tenant-b | Tenant B admin |
| USR-004 | user-a@test.com | Test123! | tenant_user | tenant-a | Regular user A |
| USR-005 | user-b@test.com | Test123! | tenant_user | tenant-b | Regular user B |
| USR-006 | inactive@test.com | Test123! | tenant_user | tenant-a | is_active = false |
| USR-007 | expired@test.com | Test123! | tenant_user | tenant-expired | Expired tenant user |
| USR-008 | noquota@test.com | Test123! | tenant_user | tenant-noquota | No quota user |
| USR-009 | user2-a@test.com | Test123! | tenant_user | tenant-a | Second user A (concurrency) |
| USR-010 | admin-disabled@test.com | Test123! | tenant_admin | tenant-disabled | Disabled tenant admin |
| USR-011 | norag@test.com | Test123! | tenant_user | tenant-norag | No RAG user |
| USR-012 | readonly@test.com | Test123! | tenant_user | tenant-a | Read-only tests |
...
|----|------|-------|----------|--------|
| AUTH-H-001 | Super admin login | admin@outpace.ai / Admin123! | 200, access_token | L20-49 |
| AUTH-H-002 | Tenant admin login | admin-a@test.com / Test123! | 200, access_token | L20-49 |
| AUTH-H-003 | Tenant user login | user-a@test.com / Test123! | 200, access_token | L20-49 |
